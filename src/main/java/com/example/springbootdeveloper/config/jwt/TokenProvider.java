...
public class TokenProvider {
    ...
    // JWT 토큰 생성 메서드
    private String makeToken(Date expiry, User user) { // 만료시간, 유저 정보를 받음
        Date now = new Date();

        // set계열의 메서드로 여러 값들을 지정
        return Jwts.builder()
    ...
    public Authentication getAuthentication(String token) {
        ...
        // 사용자 이메일이 있는 토큰 제목 sub와 토큰 기반으로 인증 정보 생성
